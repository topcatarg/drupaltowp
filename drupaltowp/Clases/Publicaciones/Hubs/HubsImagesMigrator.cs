...
internal class HubsImagesMigrator
{
    ...
    public HubsImagesMigrator(LoggerViewModel logger, CancellationService cancellation = default)
    {
        _logger = logger;
    ...
    internal async Task MigrateHubsImagesAsync()
    {
